...
export default function Sidebar({ darkMode, toggleTheme }: SidebarProps) {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-full p-4 rounded-r-xl z-50 transition-all duration-300 flex flex-col
        ${collapsed ? "w-16" : "w-64"}
    ...
    >
      ...
      {!collapsed && <h2 className="text-xl font-bold mb-6">Ifc Loader</h2>}
